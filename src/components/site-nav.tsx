...
export function SiteNav({ active }: SiteNavProps) {
  ...
  return <header className={`site-header${navVisible ? "" : " is-nav-hidden"}${landingPastHero ? " is-landing-scrolled" : ""}`}>
    ...
    <a className="wordmark" href="/" aria-label="Jogja Creative Production"><Image src="/jcp-logo-nobg.png" alt="JCP - Jogja Creative Production" width={128} height={76} priority /></a>
