...
export function ContactInquiryForm() {
  ...
  return <form className="inquiry-form" onSubmit={submit}>
    ...
    <label>Kebutuhan<select required value={form.service} onChange={(event) => setForm({ ...form, service: event.target.value })}><option value="" disabled>Pilih layanan yang Anda butuhkan</option><option>North Production</option><option>North Creative</option><option>North Photo & Video Booth</option><option>North Virtual Tour 360</option><option>Indonesia Drone Training Centre</option><option>AI Kreasi Cerdas</option></select></label>
