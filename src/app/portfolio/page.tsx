...
const projects = [
  ...
  { number: "28", category: "AI Kreasi Cerdas", client: "AI Kreasi Cerdas", title: "AI Automation", year: "2025", tone: "orange", image: "/services/ai-kreasi-cerdas-gallery/ai-kreasi-cerdas-01.jpg" },
  { number: "29", category: "AI Kreasi Cerdas", client: "AI Kreasi Cerdas", title: "Chatbot", year: "2025", tone: "ink", image: "/services/ai-kreasi-cerdas-gallery/ai-kreasi-cerdas-02.jpg" },
  { number: "30", category: "AI Kreasi Cerdas", client: "AI Kreasi Cerdas", title: "Content Generation", year: "2025", tone: "sage", image: "/services/ai-kreasi-cerdas-gallery/ai-kreasi-cerdas-03.jpg" },
  { number: "31", category: "AI Kreasi Cerdas", client: "AI Kreasi Cerdas", title: "Modern Interior", year: "2025", tone: "sun", image: "/services/ai-kreasi-cerdas-gallery/ai-kreasi-cerdas-04.jpg" },
  { number: "32", category: "Virtual Tour 360", client: "Virtual Tour 360", title: "360 Experience", year: "2025", tone: "orange", image: "/services/virtual-tour-360-gallery/virtual-tour-360-1.jpg" },
  { number: "33", category: "Virtual Tour 360", client: "Virtual Tour 360", title: "Interactive Walkthrough", year: "2025", tone: "ink", image: "/services/virtual-tour-360-gallery/virtual-tour-360-2.jpg" },
  { number: "34", category: "Virtual Tour 360", client: "Virtual Tour 360", title: "Immersive Journey", year: "2025", tone: "clay", image: "/services/virtual-tour-360-gallery/virtual-tour-360-3.jpg" },
  { number: "35", category: "Virtual Tour 360", client: "Virtual Tour 360", title: "Discover Every Corner", year: "2025", tone: "sun", image: "/services/virtual-tour-360-gallery/virtual-tour-360-4.jpg" },
];
  ...
  return (
    <main className="portfolio-page">
      ...
      <section className="portfolio-hero shell">
        ...
        <div><p>Berbagai cerita, medium, dan tantangan. Satu standar: karya yang terasa tepat untuk orang yang melihatnya.</p><span>35 projects / 6 disciplines</span></div>
      </section>
