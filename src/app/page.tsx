    ...
    <main className="landing-page">
      ...
      <footer className="site-footer">
        <div className="footer-shell">
          ...
          <div className="footer-grid"><div className="footer-company"><img className="footer-company-logo" src="/jcp-logo-nobg.png" alt="JCP - Jogja Creative Production" /><p>PT Jogja Creative Production<br />Yogyakarta, Indonesia</p><div><a href="tel:+628567874388">+62 856-787-4388</a><a href="mailto:jogjacreativeproduction@gmail.com">jogjacreativeproduction@gmail.com</a></div></div><div><span>Quick links</span><a href="/tentang">Tentang JCP</a><a href="/layanan">Layanan</a><a href="/portfolio">Portofolio</a><a href="/hubungi">Hubungi kami</a></div><div><span>Creative units</span><a href="/layanan/north-production">North Production</a><a href="/layanan/north-creative">North Creative</a><a href="/layanan/north-booth">North Photobooth</a><a href="/layanan/virtual-tour-360">Virtual Tour 360</a><a href="/layanan/drone-training">Drone Training</a><a href="/layanan/ai-kreasi-cerdas">AI Kreasi Cerdas</a></div><div><span>Follow JCP</span><a href="https://wa.me/628567874388">WhatsApp ↗</a><a href="https://www.instagram.com/jogjacreativeproduction/?utm_source=ig_web_button_share_sheet" target="_blank" rel="noreferrer">Instagram ↗</a><a href="mailto:jogjacreativeproduction@gmail.com">Email us ↗</a></div></div>
